...
- **Knowledge Retrieval**: Search the `CyberSecurity-Skills` library and external submodules (`external/SecSkills`, `external/AboutSecurity`) to find specific payloads or PoCs.
